...
class DataSyncProgress:
    ...
    Attributes:
        ...
        eta (Union[Unset, int]): ETA in second
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if app_volume is not UNSET:
            field_dict["app_volume"] = app_volume
        ...
        if job_volume is not UNSET:
            field_dict["job_volume"] = job_volume
        if notebook_volume is not UNSET:
            field_dict["notebook_volume"] = notebook_volume
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.volume_status import VolumeStatus
        d = src_dict.copy()
        if d["app_volume"]==None:
            d.update({"app_volume":UNSET})
        _app_volume = d.pop("app_volume", UNSET)
        app_volume: Union[Unset, Volume]
        ...
        _job_volume = d.pop("job_volume", UNSET)
        job_volume: Union[Unset, Volume]
        ...
        if d["notebook_volume"]==None:
            d.update({"notebook_volume":UNSET})
        _notebook_volume = d.pop("notebook_volume", UNSET)
        notebook_volume: Union[Unset, Volume]
