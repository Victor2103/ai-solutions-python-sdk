...
class Contract:
    ...
    Attributes:
        ...
        id (Union[Unset, str]):
        signed_at (Union[Unset, None, datetime.datetime]):
    ...
    signed_at: Union[Unset, None, datetime.datetime] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        id = self.id
        signed_at: Union[Unset, None, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _signed_at = d.pop("signedAt", UNSET)
        signed_at: Union[Unset, None, datetime.datetime]
        if _signed_at is None:
            signed_at = None
        elif isinstance(_signed_at, Unset):
            signed_at = UNSET
        else:
            signed_at = isoparse(_signed_at)
