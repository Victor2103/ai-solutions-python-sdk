...
def sync_detailed(
    *,
    ...
    Args:
        ...
        with_spark (Union[Unset, None, bool]): whether or not to include spark notebooks in the
            returned list
        status_state (Union[Unset, None, List[str]]): status to filter
        user_name (Union[Unset, None, str]): user to filter
        label_selector (Union[Unset, None, str]): Label selector used to filter (e.g.
